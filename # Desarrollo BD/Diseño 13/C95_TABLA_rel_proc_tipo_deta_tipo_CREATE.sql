USE sise_legal;
CREATE TABLE IF NOT EXISTS `rel_proc_tipo_deta_tipo` 
(
	...
	PRIMARY KEY (`cod_proceso_tipo`, `cod_detalle_tipo`),
	KEY `cod_proceso_tipo` (`cod_proceso_tipo`),
	CONSTRAINT `rel_proc_tipo_deta_tipo_cod_proceso_tipo_FK` FOREIGN KEY (`cod_proceso_tipo`) REFERENCES `ref_proceso_tipo`(`cod_proceso_tipo`),
	KEY `cod_detalle_tipo` (`cod_detalle_tipo`),
	CONSTRAINT `rel_proc_tipo_deta_tipo_cod_detalle_tipo_FK` FOREIGN KEY (`cod_detalle_tipo`) REFERENCES `ref_detalle_tipo`(`cod_detalle_tipo`),
	KEY `usr_ult_modif` (`usr_ult_modif`),
	CONSTRAINT `rel_proc_tipo_deta_tipo_tipo_usr_ult_modif_FK` FOREIGN KEY (`usr_ult_modif`) REFERENCES `bsd_usuario`(`cod_usuario`)
)
ENGINE = InnoDB
