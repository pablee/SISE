...
(
	...
	`razon_social` VARCHAR(100) DEFAULT NULL COMMENT 'Razon social de la persona jurídica',
	...
	`telefono` BIGINT(12) UNSIGNED DEFAULT NULL COMMENT 'telefono',
	`celular` BIGINT(12) UNSIGNED DEFAULT NULL COMMENT 'Celular',
	`correo_personal_1` VARCHAR(50) DEFAULT NULL COMMENT 'Correo Electrónico personal 1',
	`correo_personal_2` VARCHAR(50) DEFAULT NULL COMMENT 'Correo Electrónico personal 2',
	`correo_laboral_1` VARCHAR(50) DEFAULT NULL COMMENT 'Correo Electrónico laboral 1',
	`correo_laboral_2` VARCHAR(50) DEFAULT NULL COMMENT 'Correo Electrónico laboral 2',
